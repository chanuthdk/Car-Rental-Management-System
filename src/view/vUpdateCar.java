...
public class vUpdateCar extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btn_update.setBackground(new java.awt.Color(204, 0, 51));
    ...
    cUpdateCar mupdatec = new cUpdateCar();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(vUpdateCar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new vUpdateCar().setVisible(true);
            }
        });
    }
